# Script to generate MAKE guide part2.html from source text
import re

# Read source text
with open(r'c:\Users\yuto\OneDrive\Toeic-cards--main\verbs\make\guide\guide02の原文テキスト.txt', 'r', encoding='utf-8') as f:
    content = f.read()
...
<head>
	...
	<title>MAKE 句動詞 完全解説【後編】 - Phrasal Verb Master</title>
...
<body class="p-4 md:p-8 max-w-5xl mx-auto">
	...
	<header class="text-center mb-12">
		...
		<h1 class="text-3xl md:text-5xl font-black text-slate-800 mb-4">
			MAKE 句動詞 <span class="text-orange-600">完全解説【後編】</span>
		</h1>
